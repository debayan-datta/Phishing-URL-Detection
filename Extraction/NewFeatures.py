...
def count_tld(text):
    ...
    file_path = '/home/joardar/Downloads/ML Project/URL-Extraction-main/Mother Program/Feature Extraction/files/tlds.txt'
...
def extract_extension(text):
    ...
    file_path = '/home/joardar/Downloads/ML Project/URL-Extraction-main/Mother Program/Feature Extraction/files/extensions.txt'
    file = open(file_path, 'r')
